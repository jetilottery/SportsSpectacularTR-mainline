 ...
 */
define(['skbJet/componentCRDC/gladRenderer/gladButtonCollection'], function (gladButtonCollection) {
  var lastTimeStamp = 0;
  /**
  * @function GladButton
  ...
  */
  ...
  function GladButton(sprite, imgName, options) {
    ...
    _this.options.automaticSetImg = false;
    ...
    if (options) {
      ...
      if (options.automaticSetImg) {
        _this.options.automaticSetImg = true;
      }
    }
    ...
    _this.sprite.on('mouseover', function () {
      if (_this.enabled) {
        try {
          if (!_this.options.automaticSetImg) {
          ...
          if (_this.options.scaleXWhenOver !== 1 || _this.options.scaleYWhenOver !== 1) {
            sprite.updateCurrentStyle({
              '_transform': {
                '_scale': {
                  '_x': _this.options.scaleXWhenOver,
                  '_y': _this.options.scaleYWhenOver
                }
              }
            });
          }
        } catch (e) {//Nothing to do in case of mobile/tablet do not have mouse over image.
        }
      }
    });
    ...
    _this.sprite.on('mouseout', function () {
      if (_this.enabled) {
        ...
        sprite.updateCurrentStyle({
          '_transform': {
            '_scale': {
              '_x': _this.originalScaleX,
              '_y': _this.originalScaleY
            }
          }
        });
      }
      ...
      if (_this.enabled) {
        ...
        if (_this.options.scaleXWhenClick !== 1 || _this.options.scaleYWhenClick !== 1) {
          sprite.updateCurrentStyle({
            '_transform': {
              '_scale': {
                '_x': _this.options.scaleXWhenClick,
                '_y': _this.options.scaleYWhenClick
              }
            }
          });
        }
...
//# sourceMappingURL=gladButton.js.map
